...
function PlanTimeline({ dayPlan }) {
  ...
  return (
    <>
      ...
      "
      >
        <div className="absolute top-0 right-0 w-72 h-72 bg-cyan-100/60 dark:bg-cyan-500/10 rounded-full blur-[110px] pointer-events-none" />

        <div className="absolute bottom-0 left-0 w-72 h-72 bg-blue-100/50 dark:bg-blue-500/10 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="relative z-10">
          ...
          >
            ...
            <h2 className="text-5xl font-bold mt-4 text-slate-950 dark:text-white">
              Travel Timeline 🗓
            </h2>
            ...
            {dayPlan.map((day, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="relative overflow-hidden h-[280px] bg-slate-100 dark:bg-slate-700 rounded-[28px] shadow-[0_12px_30px_rgba(15,23,42,0.12)]">
                    <img
                      src={image}
                      alt={firstPlace}
                  ...
                  >
                    <div>
                      <div className="flex items-center gap-3">
                        <div className="w-11 h-11 rounded-2xl bg-cyan-50 dark:bg-cyan-500/10 border border-cyan-100 dark:border-cyan-500/20 flex items-center justify-center">
